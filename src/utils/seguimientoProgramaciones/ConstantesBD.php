...
class ConstantesBD {
    ...
    const get_unidades_asignatura_id = "SELECT ID FROM UNIDADES_TRABAJO where UNIDADES_TRABAJO.ID IN (SELECT ID_UNIDAD_TRABAJO FROM ASIGNATURA_UNIDADTRABAJO where ID_ASIGNATURA=?)";
